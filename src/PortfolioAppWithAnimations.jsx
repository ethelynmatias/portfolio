...
function PortfolioAppWithAnimations() {
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center space-x-4 mt-4">
                ...
                <a href="mailto:ethelyn.matias@example.com" className="text-gray-600 hover:text-red-600 transition-colors">
                  <Mail size={24} />
                </a>
              </div>
            </div>
            ...
            <div className="border-t pt-6 space-y-4">
              <div className="flex items-center text-base">
                ...
                <span className="text-gray-600">ethelyn.matias@example.com</span>
              </div>
              <div className="flex items-center text-base">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {experience.map((job, index) => (
                  <ScrollAnimation animation="fadeUp" delay={100 + index * 100} key={index}>
                    <div className="relative pl-8 pb-8 border-l-2 border-gray-200 last:border-l-0">
...
export default PortfolioAppWithAnimations;